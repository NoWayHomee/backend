...
-- AddForeignKey
ALTER TABLE "properties" ADD CONSTRAINT "fk_property_reviewer" FOREIGN KEY ("reviewed_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "room_types" ADD CONSTRAINT "fk_rt_property" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "fk_booking_voucher" FOREIGN KEY ("voucher_id") REFERENCES "vouchers"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "booking_guests" ADD CONSTRAINT "fk_bg_booking" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "daily_rates" ADD CONSTRAINT "fk_dr_rp" FOREIGN KEY ("rate_plan_id") REFERENCES "rate_plans"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "partner_profiles" ADD CONSTRAINT "fk_partner_reviewer" FOREIGN KEY ("kyc_reviewed_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "promotions" ADD CONSTRAINT "fk_promo_partner" FOREIGN KEY ("partner_id") REFERENCES "partner_profiles"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "property_policies" ADD CONSTRAINT "fk_policy_prop" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "rate_plans" ADD CONSTRAINT "fk_rp_rt" FOREIGN KEY ("room_type_id") REFERENCES "room_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "room_type_amenities" ADD CONSTRAINT "fk_rta_amenity" FOREIGN KEY ("amenity_id") REFERENCES "amenities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "room_type_amenities" ADD CONSTRAINT "fk_rta_rt" FOREIGN KEY ("room_type_id") REFERENCES "room_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "rooms" ADD CONSTRAINT "fk_room_property" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "rooms" ADD CONSTRAINT "fk_room_type" FOREIGN KEY ("room_type_id") REFERENCES "room_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "vouchers" ADD CONSTRAINT "fk_voucher_promo" FOREIGN KEY ("promotion_id") REFERENCES "promotions"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
